...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = $db->prepare("INSERT INTO t_responden_dosen (responden_dosen_id, survey_id, responden_tanggal, responden_nama, responden_nip, responden_unit) VALUES (NULL, ?, ?, ?, ?, ?)");
    $query->bind_param('issss', $_SESSION["ID_Survey"], $_SESSION["Tanggal"], $_SESSION["Nama"], $_SESSION["NIP"], $_SESSION["Unit"]);
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <h2 style="text-align: center;">Isi Kuesioner Dosen</h2>
      ...
      <div class="card-body">
          ...
          <div class="card card-primary">
              ...
              <h4 class="card-title w-90">
                ...
                Syarat dan Ketentuan Pengisian Kuesioner Survey Kepuasan Pelanggan Politeknik Negeri Malang
                </a>
              </h4>
            </div>
      <div class="container-fluid">
