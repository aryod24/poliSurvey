      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <label for="soal_jenis">Jenis Soal</label>
                <select id="soal_jenis" class="form-control custom-select">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form action="soal_action.php?act=edit&id=<?php echo $id?>" method="post">
               <div class="form-group">
                  <label for="soal_nama">No. Urut</label>
                  <input type="text" name="soal_urut" id="soal_urut" class="form-control" value="<?php echo $data['soal_urut']?>">
              </div>
              <div class="form-group">
                <label for="soal_jenis">Jenis Soal</label>
