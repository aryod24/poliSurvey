        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="psdmtendik.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Sistem Pengelolaan Sumber Daya Manusia</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="pktendik.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Sistem Pengelolaan Keuangan</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="psptendik.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Sistem Pengelolaan Sarana dan Prasarana</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="pkptendik.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Sistem Pengelolaan Kegiatan Penelitian</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="pkpmtendik.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
